...
<body>
	<div class="container">
		...
		<table class="table table-striped table-bordered">
		    ...
		    <tbody>
		    @foreach($jubilados as $key => $value)
		        <tr>
		            <td>{{ $value->nombre }}</td>
		            ...
		            <td>
		                ...
		                <a class="btn btn-small btn-success" href="{{ URL::to('jubilados/' . $value->id) }}">Mostrar</a>

		                <!-- edit this nerd (uses the edit method found at GET /nerds/{id}/edit -->
		                <a class="btn btn-small btn-info" href="{{ URL::to('jubilados/' . $value->id . '/edit') }}">Editar</a>
		            </td>
		        </tr>
		    @endforeach
		    </tbody>
